...
const filterSelectors = {
  countyInput: [
    ...
    'css=input[aria-label*="county" i]',
    'css=input[aria-labelledby*="county" i]',
    'role=combobox[name=/county/i]',
    'xpath=//label[contains(translate(normalize-space(.), "COUNTY", "county"), "county")]/following::input[1]',
  ],
  countySelectionContainers: [
    'xpath=//*[@id=":r2b:"]/div[1]/div[1]/div[2]/div[2]',
    'css=[data-testid="counties-search-autocomplete"]',
    'css=[data-testid*="county"][data-testid*="autocomplete"]',
    'xpath=//div[contains(@class,"autocomplete") and .//label[contains(translate(.,"COUNTY","county"),"county")]]',
  ],
